<form action="/pegawai/{{ $pegawai->id_pegawai }}/update" method="POST" id="frmPegawai" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="id_pegawai" value="{{ $pegawai->id_pegawai }}" class="form-control" placeholder="ID Pegawai" name="id_pegawai">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="nama_lengkap" value="{{ $pegawai->nama_lengkap }}" class="form-control" name="nama_lengkap" placeholder="Nama Pegawai">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="jabatan" value="{{ $pegawai->jabatan }}"class="form-control" name="jabatan" placeholder="Jabatan">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="no_hp" value="{{ $pegawai->no_hp }}" class="form-control" name="no_hp" placeholder="No HP">
            </div>
        </div>
    </div>
    <div class="row mt-2">
