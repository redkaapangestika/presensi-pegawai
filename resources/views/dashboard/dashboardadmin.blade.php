                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                ...
                                <div class="text-secondary">Pegawai Hadir</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                ...
                                <div class="text-secondary">Pegawai Izin</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <span class="bg-warning text-white avatar"><!-- Download SVG icon from http://tabler.io/icons/icon/currency-dollar -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-mood-sick">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            <div class="col">
                                ...
                                <div class="text-secondary">Pegawai Sakit</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                ...
                                <div class="text-secondary">Pegawai Terlambat</div>
                            </div>
                        </div>
                    </div>
                </div>
