...
<div class="section" id="user-section">
            <div id="user-detail">
                ...
                <div id="user-info">
                    <h3 id="user-name">Riska Dian Nur Lestari, S.TP., M.Sc</h3>
                    <span id="user-role">Carik</span>
                </div>
            </div>
        </div>
                        ...
                        <ul class="listview image-listview">
                            <li>
                                <div class="item">
                                    ...
                                    <div class="in">
                                        <div>Dr. Reno Candra Sangaji, S.IP., M.IP</div>
                                        <span class="text-muted">Lurah</span>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="item">
                                    <img src="assets/img/sample/avatar/avatar1.jpg" alt="image" class="image">
                                    <div class="in">
                                        <div>Riska Dian Nur Lestari, S.TP., M.Sc</div>
                            ...
                            <li>
                                <div class="item">
                                    <img src="assets/img/sample/avatar/avatar1.jpg" alt="image" class="image">
                                    <div class="in">
                                        <div>Al Thouvik Sofisalam, Amd</div>
                                    </div>
                                </div>
                            </li>
                        </ul>
