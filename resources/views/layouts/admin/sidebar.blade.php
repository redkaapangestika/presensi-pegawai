  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="sidebar-menu">
      <ul class="navbar-nav pt-lg-3">
        ...
        {{-- ============================================================ --}}
        {{-- ADMIN ONLY — Data Master (Pegawai & Departemen) --}}
        {{-- ============================================================ --}}
        @if(Auth::guard('user')->user()->role == 'admin')

        <li class="nav-item">
          <span class="nav-link-title ms-3 small text-muted text-uppercase" style="font-size:0.65rem; letter-spacing:0.08em;">Master Data</span>
        </li>

        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#navbar-data-master" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="false">
            <span class="nav-link-icon d-md-none d-lg-inline-block">
              <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
        ...
        {{-- ============================================================ --}}
        {{-- PETUGAS ONLY — Monitoring Presensi --}}
        {{-- ============================================================ --}}
        @if(Auth::guard('user')->user()->role == 'petugas')

        <li class="nav-item">
          <span class="nav-link-title ms-3 small text-muted text-uppercase" style="font-size:0.65rem; letter-spacing:0.08em;">Operasional</span>
        </li>
        ...
        <li class="nav-item">
          <span class="nav-link-title ms-3 small text-muted text-uppercase" style="font-size:0.65rem; letter-spacing:0.08em;">Laporan</span>
        </li>

        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#navbar-laporan" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="false">
            <span class="nav-link-icon d-md-none d-lg-inline-block">
              <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
